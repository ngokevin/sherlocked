...
function run(testConfig) {
    if (!process.env.SAUCE_ACCESS_KEY || !process.env.SAUCE_USERNAME) {
        console.log('SAUCE_ACCESS_KEY or SAUCE_USERNAME could not be found.');
        console.log('Check that these environment variables are being set ' +
                    'or that the pull request is not from a fork repository.');
        return;
    }
