    ...
    var testQueue = testConfig.captures.map(function(captureObj) {
        return function() {
            return new Promise(function(resolve) {
                ...
                if (captureNamesUnique.indexOf(captureName) !== -1) {
                    console.log(captureName + ' has already been logged for ' +
                                'evidence. Capture names must be unique.');
                    resolve();
                }
